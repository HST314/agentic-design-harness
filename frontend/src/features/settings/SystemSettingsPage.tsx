        ...
        <div id="settings-panel-harness" role="tabpanel" aria-labelledby="settings-tab-harness" className="settings-panel">
          ...
          <section className="settings-section">
            ...
            <div className="settings-grid settings-grid--three">
              ...
              <label className="settings-field" htmlFor="default-start-policy"><span>启动方式</span><select id="default-start-policy" value={draft.harness.master.default_start_policy} onChange={(event) => update("harness.master.default_start_policy", event.currentTarget.value)}><option value="manual">人工确认计划后运行</option><option value="auto">自动生成计划，人工确认后运行</option></select><small>新任务创建时继承此启动方式。</small></label>
            </div>
